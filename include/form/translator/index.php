...
<form id="create-discussion-translator" class="keys-translr__box-form pt-30 pb-30">
    <div class="mb-20">
        ...
        <input type="text" id="keys-translr__box-form_title" name="title" value="Заголовок key" required />
    </div>
    <div class="mb-20">
        <div>
    ...
    <div class="mb-20">
        ...
        <textarea name="comment" id="keys-translr__box-form_comment" cols="30" rows="5">Комментарий key</textarea>
    </div>
